...
public class TextDisplayMixin implements TextDisplayExtension {
    ...
    @Unique
    private boolean wynncraftspellhider_hasChecked = false;
    ...
    public void wynncraftspellhider_setSpellGroup(SpellGroup group) {
        wynncraftspellhider_spellGroup = group;
    }

    @Override
    public boolean wynncraftspellhider_hasChecked() {
        return wynncraftspellhider_hasChecked;
    }

    @Override
    public void wynncraftspellhider_setHasChecked(boolean hasChecked) {
        this.wynncraftspellhider_hasChecked = hasChecked;
    }
}
